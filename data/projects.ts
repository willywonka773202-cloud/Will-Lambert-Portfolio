...
export interface Project {
  slug: string;
  name: string;
  /** Short, grounded one-liner used on cards. */
  description: string;
  ...
  github: string;
  githubUrl: string;
  /** Vercel project name, if a deployment is known. */
  vercelProjectName?: string;
  /** Verified, working production URL. Only set when confirmed reachable. */
  liveUrl?: string;
  techStack: string[];
  /** Best-known last-updated date (from GitHub `pushed_at`). Placeholder-friendly. */
  lastUpdated: string;
  featured: boolean;
...
/**
 * Source of truth: willywonka773202-cloud GitHub + Vercel.
 * Descriptions are grounded in real repo names and verified live-app content.
...
export const projects: Project[] = [
  {
    ...
    github: "willywonka773202-cloud/sylistly",
    githubUrl: "https://github.com/willywonka773202-cloud/sylistly",
    vercelProjectName: "sylistly",
  ...
  },
  {
    ...
    github: "willywonka773202-cloud/bertos-ai-os",
    githubUrl: "https://github.com/willywonka773202-cloud/bertos-ai-os",
    vercelProjectName: "bertos-ai-os",
  ...
  },
  {
    ...
    github: "willywonka773202-cloud/carpool-optimizer",
    githubUrl: "https://github.com/willywonka773202-cloud/carpool-optimizer",
    vercelProjectName: "carpool-optimizer",
  ...
  },
  {
    ...
    github: "willywonka773202-cloud/vibe-coding-platform",
    githubUrl: "https://github.com/willywonka773202-cloud/vibe-coding-platform",
    vercelProjectName: "vibe-coding-platform",
